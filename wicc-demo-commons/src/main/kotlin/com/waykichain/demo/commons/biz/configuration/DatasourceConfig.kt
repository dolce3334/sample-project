...
import com.waykichain.demo.commons.biz.env.Environment
...
@EnableJpaRepositories(
    ...
    basePackages= arrayOf("com.waykichain.demo.repository"))
@Primary
open class DatasourceConfig {
    ...
    open fun entityManagerFactory(builder: EntityManagerFactoryBuilder): LocalContainerEntityManagerFactoryBean {
        return builder
            ...
            .packages("com.waykichain.demo.entity.domain") //设置实体类所在位置
    ...
    open fun entityManagerFactoryBetSql(): SqlSessionFactory {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath*:com/waykichain/demo/mapper/*.xml"))

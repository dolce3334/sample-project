package com.waykichain.rcenter.commons.biz.env
...
object Environment {
    ...
    @JvmField
    val MYSQL_URL = BaseEnv.env("MYSQL_URL", "jdbc:mysql://dev-mysql.wic.me:3306/wicc-bet?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&useSSL=false")

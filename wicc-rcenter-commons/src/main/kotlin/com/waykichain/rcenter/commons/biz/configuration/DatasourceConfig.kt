package com.waykichain.rcenter.commons.biz.configuration

import com.alibaba.druid.pool.DruidDataSource
import com.waykichain.rcenter.commons.biz.env.Environment
...
@EnableJpaRepositories(
    ...
    basePackages= arrayOf("com.waykichain.rcenter.repository"))
@Primary
open class DatasourceConfig {
    ...
    open fun entityManagerFactory(builder: EntityManagerFactoryBuilder): LocalContainerEntityManagerFactoryBean {
        return builder
            ...
            .packages("com.waykichain.rcenter.entity.domain") //设置实体类所在位置
    ...
    open fun entityManagerFactoryBetSql(): SqlSessionFactory {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath*:com/waykichain/rcenter/mapper/*.xml"))
